responses_dict = {
        ...
        "exp": ["รำคาญ", "นอนเถอะ", "พอใจยัง", "เพื่อ?", "อีกนานป้ะ","มึงทำทำไม","มึงบ้าอ่อ", "บ้าไม่เลิก", "สักทีเหอะ", "รำคาญค่ะ", "ไสหัวด่วน","รกโลกเนาะ",
                "เอ๋อจริง","ไอเอ๋อ","กุรำคาญ","อีกแล้ว","อีกละ?","ต้องการไร","?"],
        "คำ": ["เรื่องของใคร", "แล้ว", "อะไรนะ", "กุอ่านภาษาควายไม่ออก", "เลิกเอ๋อกี่โมง","ไอหน้าแตด"],
